...
1. Download predict.py and model.bin file to your local disk
2. Install python modules using pip.lock file
3. Run the predict.py with Mushroom attribute as arguments
